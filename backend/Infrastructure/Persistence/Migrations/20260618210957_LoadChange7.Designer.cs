...
namespace Persistence.Migrations
{
    ...
    [Migration("20260618210957_LoadChange7")]
    partial class LoadChange7
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoadEntityUser", b =>
                {
                    b.Property<Guid>("SavedLoadsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("UsersSavesId")
                        .HasColumnType("uuid");

                    b.HasKey("SavedLoadsId", "UsersSavesId");

                    b.HasIndex("UsersSavesId");

                    b.ToTable("UserSavedLoads", (string)null);
                });
            ...
            modelBuilder.Entity("LoadEntityUser", b =>
                {
                    b.HasOne("Domain.Models.Load.LoadEntity", null)
                        .WithMany()
                        .HasForeignKey("SavedLoadsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UsersSavesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });

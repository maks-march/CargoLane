    ...
    <div className="auth-page active">
      <div className="auth-left">
        <div className="auth-content">
          ...
          <p className="auth-subtitle">Sign up to your Cargolane workspace.</p>
          ...
          <button className="google-btn" type="button">
            <svg width="18" height="18" viewBox="0 0 18 18">
              ...
              <path fill="#FBBC05" d="M3.964 10.71c-.18-.54-.282-1.116-.282-1.71s.102-1.17.282-1.71V4.958H.957C.347 6.173 0 7.548 0 9s.348 2.827.957 4.042l3.007-2.332z"/>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <div className="form-label"><label>Retry password</label></div>
              <input type="password" className="form-input" defaultValue="••••••••••" />
            </div>
